...
var handlerFunctions = (function() {
    ...
    function checkCookie(req, res, destination) {
        ...
        if (accessCookie) {
            ...
            if (sessions[accessCookie.split(';')[0]]) {
              // accessCookie.split(';')[0]  should look like this: 4707188&katkelemen
              // accessCookie.split(';')[0].split('&')[0]   : 4707188
    ...
    function authWithAT(res, data, index) {
        ...
        var getOptions = {
          ...
          headers: {'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36'}
        };
